...
import com.wishme.schoolLetter.common.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex) {
        log.error("handleEmptyResultDataAccessException", ex);
        final ErrorResponse response = ErrorResponse.of(ErrorCode.NOT_FOUND_DATA_ERROR, ex.getMessage());
        return new ResponseEntity<>(response, HttpStatus.NOT_FOUND);
    }
